...
(function dartProgram() {
    ...
    G.bE.prototype = {
        cP: function() {
            ...
            for (u = ["reimu", "marisa", "rumia", "daiyousei", "cirno", "hong", "koakuma", "patchouli", "sakuya", "remilia", "flandre","tigershark", "dark"],
            t = this.gd9(),
            s = 0; s < 13; ++s) {
                r = u[s]
                q = $.ic.i(0, r)
